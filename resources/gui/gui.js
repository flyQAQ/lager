...
var $author$project$Main$Model = F4(
	function (server, status, detail, state) {
		return {detail: detail, server: server, state: state, status: status};
	});
var $author$project$Main$NoStep = {$: 'NoStep'};
var $author$project$Main$TreeState = F2(
	function (actionTreeState, modelTreeState) {
		return {actionTreeState: actionTreeState, modelTreeState: modelTreeState};
	});
...
var $author$project$Main$Status = F4(
	function (program, summary, cursor, paused) {
		return {cursor: cursor, paused: paused, program: program, summary: summary};
	});
var $author$project$Main$initStatus = A4($author$project$Main$Status, '', 0, 0, false);
var $author$project$Main$initModel = function (server) {
	return A4(
		$author$project$Main$Model,
		server,
		$author$project$Main$initStatus,
		$author$project$Main$NoStep,
		A2($author$project$Main$TreeState, $klazuka$elm_json_tree_view$JsonTree$defaultState, $klazuka$elm_json_tree_view$JsonTree$defaultState));
};
var $author$project$Main$RecvStatus = function (a) {
	return {$: 'RecvStatus', a: a};
};
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map4 = _Json_map4;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$decodeStatus = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Main$Status,
	A2($elm$json$Json$Decode$field, 'program', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'summary', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'cursor', $elm$json$Json$Decode$int),
...
var $author$project$Main$queryStatus = function (server) {
	var url = server + '/api';
	return A2(
		$elm$http$Http$send,
		$author$project$Main$RecvStatus,
		A2($elm$http$Http$get, url, $author$project$Main$decodeStatus));
};
var $author$project$Main$init = function (flags) {
	var model = $author$project$Main$initModel(flags.server);
	var cmd = $author$project$Main$queryStatus(flags.server);
...
var $author$project$Main$detailIndex = function (d) {
	switch (d.$) {
		case 'LoadedStep':
			var idx = d.a;
			return idx;
...
var $author$project$Main$RecvPost = function (a) {
	return {$: 'RecvPost', a: a};
};
...
var $author$project$Main$queryGoto = F2(
	function (server, index) {
		var url = server + ('/api/goto/' + $elm$core$String$fromInt(index));
		return A2(
			$elm$http$Http$send,
			$author$project$Main$RecvPost,
			A3(
				$elm$http$Http$post,
				url,
...
var $author$project$Main$queryPause = function (server) {
	var url = server + '/api/pause';
	return A2(
		$elm$http$Http$send,
		$author$project$Main$RecvPost,
		A3(
...
var $author$project$Main$queryRedo = function (server) {
	var url = server + '/api/redo';
	return A2(
		$elm$http$Http$send,
		$author$project$Main$RecvPost,
		A3(
...
var $author$project$Main$queryResume = function (server) {
	var url = server + '/api/resume';
	return A2(
		$elm$http$Http$send,
		$author$project$Main$RecvPost,
		A3(
...
var $author$project$Main$queryUndo = function (server) {
	var url = server + '/api/undo';
	return A2(
		$elm$http$Http$send,
		$author$project$Main$RecvPost,
		A3(
...
var $author$project$Main$ChangingStep = F2(
	function (a, b) {
		return {$: 'ChangingStep', a: a, b: b};
	});
var $author$project$Main$LoadingStep = function (a) {
	return {$: 'LoadingStep', a: a};
};
var $author$project$Main$LoadedStep = F2(
	function (a, b) {
		return {$: 'LoadedStep', a: a, b: b};
	});
var $author$project$Main$RecvStep = function (a) {
	return {$: 'RecvStep', a: a};
};
...
var $author$project$Main$decodeStep = A3(
...
var $author$project$Main$queryStep = F2(
	function (server, index) {
		var url = server + ('/api/step/' + $elm$core$String$fromInt(index));
		return A2(
			$elm$http$Http$send,
			$author$project$Main$RecvStep,
			A2(
				$elm$http$Http$get,
				url,
				A2(
					$elm$json$Json$Decode$map,
					$author$project$Main$LoadedStep(index),
					$author$project$Main$decodeStep)));
	});
var $author$project$Main$selectStep = F2(
	function (model, index) {
		if ((index < 0) || (_Utils_cmp(index, model.status.summary) > 0)) {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
			var detail = function () {
				var _v0 = model.detail;
				switch (_v0.$) {
					case 'LoadedStep':
						var step = _v0.b;
						return A2($author$project$Main$ChangingStep, index, step);
					case 'ChangingStep':
						var step = _v0.b;
						return A2($author$project$Main$ChangingStep, index, step);
					case 'LoadingStep':
						return $author$project$Main$LoadingStep(index);
					default:
						return $author$project$Main$LoadingStep(index);
				}
			}();
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{detail: detail}),
				A2($author$project$Main$queryStep, model.server, index));
		}
	});
var $author$project$Main$selectGotoStep = F2(
	function (model, index) {
		var _v0 = A2($author$project$Main$selectStep, model, index);
		var newModel = _v0.a;
		var cmd = _v0.b;
		var newCmd = _Utils_eq(
			index,
			$author$project$Main$detailIndex(newModel.detail)) ? $elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					cmd,
					A2($author$project$Main$queryGoto, model.server, index)
				])) : cmd;
		return _Utils_Tuple2(newModel, newCmd);
	});
var $author$project$Main$setState = F3(
	function (model, action, mod) {
		return _Utils_update(
			model,
			{
				state: {actionTreeState: action, modelTreeState: mod}
			});
	});
		...
		switch (msg.$) {
			case 'RecvStatus':
				if (msg.a.$ === 'Ok') {
					...
					var newModel = _Utils_update(
						model,
						{status: status});
					var index = $author$project$Main$detailIndex(model.detail);
					return (_Utils_eq(index, -1) || ((!_Utils_eq(status.cursor, model.status.cursor)) && _Utils_eq(index, model.status.cursor))) ? A2($author$project$Main$selectStep, newModel, status.cursor) : _Utils_Tuple2(
						newModel,
						$author$project$Main$title('debugging: ' + status.program));
				} else {
					var err = msg.a.a;
					return A2(
						$elm$core$Debug$log,
			...
			case 'RecvStep':
				if (msg.a.$ === 'Ok') {
					var detail = msg.a.a;
					if (_Utils_eq(
						$author$project$Main$detailIndex(detail),
						$author$project$Main$detailIndex(model.detail))) {
						var newModel = _Utils_update(
							model,
							{detail: detail});
						return _Utils_Tuple2(
							A3($author$project$Main$setState, newModel, $klazuka$elm_json_tree_view$JsonTree$defaultState, $klazuka$elm_json_tree_view$JsonTree$defaultState),
			...
			case 'RecvPost':
				if (msg.a.$ === 'Ok') {
					return _Utils_Tuple2(
						A3($author$project$Main$setState, model, $klazuka$elm_json_tree_view$JsonTree$defaultState, $klazuka$elm_json_tree_view$JsonTree$defaultState),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
					return _Utils_Tuple2(
			...
			case 'SelectStep':
				var index = msg.a;
				return A2($author$project$Main$selectStep, model, index);
			case 'GotoStep':
				var index = msg.a;
				return _Utils_Tuple2(
					model,
			...
			case 'Pause':
				return _Utils_Tuple2(
					model,
					$author$project$Main$queryPause(model.server));
			case 'Resume':
				return _Utils_Tuple2(
					model,
					$author$project$Main$queryResume(model.server));
			case 'TogglePause':
				return _Utils_Tuple2(
					model,
					model.status.paused ? $author$project$Main$queryResume(model.server) : $author$project$Main$queryPause(model.server));
			case 'Undo':
				return _Utils_Tuple2(
					model,
					$author$project$Main$queryUndo(model.server));
			case 'Redo':
				return _Utils_Tuple2(
					model,
					$author$project$Main$queryRedo(model.server));
			case 'KeyUp':
				return A2(
					$author$project$Main$selectStep,
					model,
					$author$project$Main$detailIndex(model.detail) - 1);
			case 'KeyDown':
				return A2(
					$author$project$Main$selectStep,
					model,
			...
			case 'KeyGoUp':
				return A2(
					$author$project$Main$selectGotoStep,
					model,
					$author$project$Main$detailIndex(model.detail) - 1);
			case 'KeyGoDown':
				return A2(
			...
			case 'Tick':
				...
				return _Utils_Tuple2(
					model,
					$author$project$Main$queryStatus(model.server));
			case 'SetActionViewState':
				var state = msg.a;
				return _Utils_Tuple2(
					A3($author$project$Main$setState, model, state, model.state.modelTreeState),
					$elm$core$Platform$Cmd$none);
			case 'SetModelViewState':
				var state = msg.a;
				return _Utils_Tuple2(
					A3($author$project$Main$setState, model, model.state.actionTreeState, state),
					$elm$core$Platform$Cmd$none);
			default:
				var path = msg.a;
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$viewNoStep = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('info')
	...
	_List_fromArray(
		[
			$elm$html$Html$text('No step selected')
		]));
var $author$project$Main$SetActionViewState = function (a) {
	return {$: 'SetActionViewState', a: a};
};
var $author$project$Main$SetModelViewState = function (a) {
	return {$: 'SetModelViewState', a: a};
};
var $author$project$Main$Selected = function (a) {
	return {$: 'Selected', a: a};
};
var $klazuka$elm_json_tree_view$JsonTree$defaultColors = {bool: 'firebrick', _null: 'gray', number: 'blue', selectable: '#fafad2', string: 'green'};
...
var $klazuka$elm_json_tree_view$JsonTree$parseString = function (string) {
	return A2(
		$elm$core$Result$andThen,
		$klazuka$elm_json_tree_view$JsonTree$parseValue,
		...
		switch (_v0.$) {
			case 'TString':
				...
				return A4(
					...
					$klazuka$elm_json_tree_view$JsonTree$css.string(colors),
					'\"' + (str + '\"'),
					node,
					config);
			case 'TFloat':
				...
				return A4(
					$klazuka$elm_json_tree_view$JsonTree$viewScalar,
					$klazuka$elm_json_tree_view$JsonTree$css.number(colors),
			...
			case 'TBool':
				...
				return A4(
					$klazuka$elm_json_tree_view$JsonTree$viewScalar,
					$klazuka$elm_json_tree_view$JsonTree$css.bool(colors),
					boolToString(bool),
					node,
					config);
			case 'TNull':
				return A4(
					$klazuka$elm_json_tree_view$JsonTree$viewScalar,
					$klazuka$elm_json_tree_view$JsonTree$css._null(colors),
					'null',
					node,
					config);
			case 'TList':
...
var $klazuka$elm_json_tree_view$JsonTree$view = F3(
	function (node, config, state) {
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$klazuka$elm_json_tree_view$JsonTree$hoverStyles(config),
				A4($klazuka$elm_json_tree_view$JsonTree$viewNodeInternal, 0, config, node, state)));
	});
var $author$project$Main$viewJson = F3(
	function (json, state, msg) {
		var encode = $elm$json$Json$Encode$encode(4);
		var parseResult = $klazuka$elm_json_tree_view$JsonTree$parseString(
			encode(json));
		var config = function (allowSelection) {
			return {
				colors: $klazuka$elm_json_tree_view$JsonTree$defaultColors,
				onSelect: allowSelection ? $elm$core$Maybe$Just($author$project$Main$Selected) : $elm$core$Maybe$Nothing,
				toMsg: msg
			};
		};
		return A2(
			...
			_List_fromArray(
				[
					function () {
					if (parseResult.$ === 'Ok') {
						var rootNode = parseResult.a;
						return A3(
							$klazuka$elm_json_tree_view$JsonTree$view,
							rootNode,
							config(false),
							state);
					} else {
				...
				if (_v0.$ === 'Just') {
					...
					return _List_fromArray(
						[
							...
							A3($author$project$Main$viewJson, action, model.state.actionTreeState, $author$project$Main$SetActionViewState),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
							...
							A3($author$project$Main$viewJson, step.model, model.state.modelTreeState, $author$project$Main$SetModelViewState)
						]);
				} else {
					return _List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('initial model')
								])),
							A3($author$project$Main$viewJson, step.model, model.state.modelTreeState, $author$project$Main$SetModelViewState)
						]);
				}
...
var $author$project$Main$viewDetail = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		function () {
			...
			switch (_v0.$) {
				case 'LoadedStep':
					...
					return _List_fromArray(
						[
							A2($author$project$Main$viewStep, model, s)
						]);
				case 'ChangingStep':
					var idx = _v0.a;
					var s = _v0.b;
				...
				default:
					return _List_fromArray(
						[$author$project$Main$viewNoStep]);
			}
		}());
};
var $author$project$Main$Pause = {$: 'Pause'};
var $author$project$Main$Resume = {$: 'Resume'};
var $author$project$Main$viewPlayButton = function (paused) {
	return paused ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('button'),
				$elm$html$Html$Events$onClick($author$project$Main$Resume)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text('⏵')
...
var $author$project$Main$classes = function (cls) {
	return $elm$html$Html$Attributes$class(
		A2(
			...
			A2(
				...
				A2($elm$core$List$filter, $elm$core$Tuple$first, cls))));
};
var $author$project$Main$viewRedoButton = function (status) {
	var disabled = _Utils_eq(status.cursor, status.summary);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('block tt hl')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(model.status.program)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(model.server)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('hl')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(model.status.summary))
									])),
				...
				_List_fromArray(
					[
						$author$project$Main$viewPlayButton(model.status.paused),
						$author$project$Main$viewRedoButton(model.status),
						$author$project$Main$viewUndoButton(model.status)
					]))
			]));
};
...
var $author$project$Main$GotoStep = function (a) {
	return {$: 'GotoStep', a: a};
};
var $author$project$Main$SelectStep = function (a) {
	return {$: 'SelectStep', a: a};
};
...
var $author$project$Main$viewHistoryItem = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2(true, 'step'),
							_Utils_Tuple2(
							_Utils_eq(selected, idx),
							'selected'),
							_Utils_Tuple2(
							_Utils_eq(cursor, idx),
							'cursor')
						])),
					$elm$html$Html$Events$onClick(
					$author$project$Main$SelectStep(idx)),
					$elm$html$Html$Events$onDoubleClick(
					$author$project$Main$GotoStep(idx))
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Main$viewHistory = function (model) {
	var selected = $author$project$Main$detailIndex(model.detail);
	var selectors = A2(
		$elm$core$List$map,
		function (idx) {
			return _Utils_Tuple2(
				$elm$core$String$fromInt(idx),
				A3($author$project$Main$viewHistoryItem, model.status.cursor, selected, idx));
		},
		A2($elm$core$List$range, 0, model.status.summary));
	return A3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$viewDetail(model),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'server', $elm$json$Json$Decode$string)))(0)}});}(this));